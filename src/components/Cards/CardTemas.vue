<template>
  <v-card
    ...
    exact
    :id="to"
    @mouseover.native="ascender(to)"
    @mouseleave.native="descender(to)"
    hover
    ripple
    :class="gradient"
    class="white--text "
  >
    <v-container fluid grid-list-lg>
      <v-layout>
        <v-flex> <v-img :src="img" height="150px" contain> </v-img> </v-flex>
      </v-layout>
    </v-container>
  </v-card>
</template>
...
.grad4 {
  background: #7b1fa2; /* fallback for old browsers */
